...
def main():
    ...
    parser.add_argument("-o", dest="outputPath", default="./subjToDept.json", help="Path to output converted file to.")
    parser.add_argument("-d", dest="getDepts", action="store_true", help="Only use this flag if you need to regenerate subjToDept.json")
    parser.add_argument("-e", dest="secondInput", default=None, help="Takes a second path to try and determine name/email mapping. Pass formatted file to i argument.")
